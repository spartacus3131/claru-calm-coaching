    ...
    <div className="min-h-[100dvh] bg-gradient-to-b from-background via-background to-accent/5">
      ...
      <main className="px-6 py-12 max-w-2xl mx-auto">
        ...
        <section className="text-center mb-8 animate-fade-in">
          ...
          <Link
            href="/try"
            className="inline-flex items-center justify-center text-lg px-8 py-4 rounded-full bg-primary text-primary-foreground shadow-lg hover:shadow-xl hover:bg-primary/90 transition-all"
          >
