/**
 * @file ChallengeDetailDrawer.tsx
 * @description Drawer component showing challenge details with start action
 * @module challenges
 *
 * Displays full challenge information in a bottom drawer, including:
 * - Challenge metadata (time, energy, value)
 * - What you'll get section
 * - Step-by-step foundation guide
 * - Tips and research insights
 * - Start Foundation button
 */
        ...
        <div className="overflow-y-auto px-4 pb-6">
          <DrawerHeader className="px-0">
            <div className="flex items-center gap-3 mb-2">
              ...
              >
                {isCompleted ? <Check className="w-5 h-5" /> : id}
              </div>
            ...
            {!isCompleted && (
              ...
              >
                ...
                {isActive ? 'Continue Foundation' : 'Start Foundation'}
              </Button>
            )}
          </DrawerHeader>
